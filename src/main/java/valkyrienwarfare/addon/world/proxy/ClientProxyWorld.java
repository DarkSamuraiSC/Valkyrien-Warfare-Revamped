...
public class ClientProxyWorld extends CommonProxyWorld {
    ...
    public void init(FMLStateEvent e) {
        this.registerBlockItem(ValkyrienWarfareWorld.INSTANCE.etheriumOre);
        this.registerBlockItem(ValkyrienWarfareWorld.INSTANCE.quartz_fence);
        this.registerBlockItem(ValkyrienWarfareWorld.INSTANCE.skydungeon_controller);
    }

    @Override
    public void postInit(FMLStateEvent e) {
        this.registerItemModel(ValkyrienWarfareWorld.INSTANCE.etheriumCrystal);
    }
